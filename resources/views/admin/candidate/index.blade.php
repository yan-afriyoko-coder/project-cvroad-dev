              ...
              <div class="card info-card revenue-card">
                ...
                <div class="filter">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    ...
                    <li><a class="dropdown-item" href="{{route('admin.candidate_suspended')}}"><i class="bi bi-eye"></i>Show</a></li>
                    <li><a class="dropdown-item" href="#"><i class="bi bi-file-excel"></i>Export</a></li>                    
                  </ul>
                </div>
              ...
              <div class="card info-card customers-card">
                ...
                <div class="filter">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    ...
                    <li>                      
                      <a class="dropdown-item" href="{{route('admin.candidate_pending')}}"> <i class="bi bi-check"></i> Show</a>
                    </li>
                    <li><a class="dropdown-item" href="#"> <i class="bi bi-file-excel"></i> Export</a></li>                    
                  </ul>
                </div>
                          ...
                          <td>
                            <div class="text-end">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                  ...
                                  <li>
                                    <div>
                                        <form action="{{route('admin.candidate_suspend',[$profile->id])}}">                                            
                                        </form>
                                        <button class="btn-confirm dropdown-item"> <i class="bi bi-ban"></i> Suspend Candidate</button>
                                    </div>
                                  </li>                                  
                                </ul>
                              </div>
