        ...
        <div class="row mt-4 py-md-2 mb-md-4">
          <div class="col-lg-6 item">
            <div class="testimonial-content">
              ...
              <div class="bottom-info mt-4">
                <a class="comment-img" href="#url"><img src="{{asset('assets/images/team1.jpg')}}" class="img-responsive"
          ...
          <div class="col-lg-6 item mt-lg-0 mt-5">
            <div class="testimonial-content">
              ...
              <div class="bottom-info mt-4">
                <a class="comment-img" href="#url"><img src="{{asset('assets/images/team2.jpg')}}" class="img-responsive"
                    alt="placeholder image"></a>
                <div class="people-info align-self">
