        ...
        <div class="col-lg-6 mx-auto">
          ...
          <div class="contact-page">
            ...
            <form method="POST" action="{{route('deal.register')}}">
              ...
              <!-- Name input -->
              <div class="mb-3">
                <input class="form-control" name="dname" type="text" placeholder="Dealership Name *" data-sb-validations="required" />
              ...
              <div class="mb-3 d-flex">
                   <a href="{{route('register')}}" class="btn-link" style="text-decoration:none">Register as Candidate</a>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;or &nbsp;<a class="btn-link" href="{{route('login')}}" style="text-decoration:none">Login </a>
