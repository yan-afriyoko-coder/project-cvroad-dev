         ...
         <div class="carousel-inner text-center">          
            @for ($count = 0; $count < $cat_loops; $count ++)
              <div class="carousel-item {{$index === 0 ? 'active' : '' }}">                
                ...
                {{-- <div class="card-item">
                  <div class="photo">
                    <img class="main-state" src="{{asset('assets/img/icon/graphic.svg')}}" alt="">
                    <img class="hover" src="{{asset('assets/img/icon/graphic-hover.svg')}}" alt="">
                  </div>
                  <p>Graphic<br>
                    Designer</p>
                </div>
                <div class="card-item">
                  <div class="photo">
                    <img class="main-state" src="{{asset('assets/img/icon/pm.svg')}}" alt="">
                    <img class="hover" src="{{asset('assets/img/icon/pm-hover.svg')}}" alt="">
                  </div>
                  <p>Project<br>
                    Management</p>
                </div>
                <div class="card-item">
                  <div class="photo">
                    <img class="main-state"src="{{asset('assets/img/icon/marketing.svg')}}" alt="">
                    <img class="hover" src="{{asset('assets/img/icon/marketing-active.svg')}}" alt="">
                  </div>
                  <p>Marketing &<br>
                    Communication</p>
                </div> --}}
