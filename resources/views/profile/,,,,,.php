                            ...
                            <div class="form-group">
                                <label for="software">Dealer Software Experience</label>
                                 <input type="text" class="form-control" name="software">
                                    ...
                                    <select  name="category"  placeholder="Select Department" id="category_id" class="categoryname"
                            ...
                            <option value="{{$cat->id}}">{{$cat->name}}</option>
                              @endforeach
                                ...
                                <div class="form-group">
                                    ...
                                    <select  name="title"  placeholder="Select title" id="title" class="title" 
                                        > <option value="">--select--</option>
                                    </select>
                                </div>
                                </div>
